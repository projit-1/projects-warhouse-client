...
const TearmsAndCondation = () => {
    return (
        <div>
            <div className="tearms-condition container">
                <h2>Terms and Conditions</h2>
                <h5>Welcome to nselectronics!</h5>
                <p>These terms and conditions outline the rules and regulations for the use of NS Electronics's Website, located at http://localhost:3000/.</p>
                <br />
                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use nselectronics if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <h3>Cookies</h3>
                <p>We employ the use of cookies. By accessing nselectronics, you agreed to use cookies in agreement with the NS Electronics's Privacy Policy.</p>
                <br />
                ...
                <p>You must not:</p>
                <br />
                <p>•	Republish material from nselectronics</p>

                <p>  •	Sell, rent or sub-license material from nselectronics</p>
                <p>    •	Reproduce, duplicate or copy material from nselectronics</p>
                <p>   •	Redistribute content from nselectronics</p>
                <br />
                ...
                <br />
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. NS Electronics does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of NS Electronics,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, NS Electronics shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
                <br />
                <p>NS Electronics reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
                <br />
                ...
                <br />
                <p>You hereby grant NS Electronics a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
                ...
                <br />
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of NS Electronics; and (d) the link is in the context of general resource information.</p>
                <br />
                <p>These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party’s site.
                    <br />
                    If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to NS Electronics. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
                </p>
                <br />
                ...
                <br />
                <p>No use of NS Electronics's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                <br />
                <h3>iFrames</h3>
...
export default TearmsAndCondation;